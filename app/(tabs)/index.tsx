...
const QUOTES_SHEET_URL = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vSIGLEWzgRWABO-RfCA1hq2hkukWxz5IgZ6ku-Bwh925lASV2wT1OzMWupnB61NjNhguC_gWmBT7TfU/pub?gid=1191891170&single=true&output=csv';
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <View style={styles.buttonContainer}>
          <Button title="Meditation" onPress={() => router.push('/next-screen')} />
        </View>
